...
contract MoralityContentStorage is Moderatable{
    ...
    // ------------------------------------------------------------------------
    function addContentViaEvent(address contentCreator, uint256 articleId, uint256 subArticleId, uint256 contentId, uint256 timestamp, string calldata data) onlyModerators external {
    ...
    // ------------------------------------------------------------------------
    function addContent(address contentCreator, uint256 articleId, uint256 subArticleId, uint256 contentId, uint256 timestamp, string calldata data) onlyModerators external {
    ...
    // Get all article ids
    // ------------------------------------------------------------------------
    function getAllArticleIds() external view returns(uint256[] memory) {
    ...
    // ------------------------------------------------------------------------
    function getAllSubArticleIds() external view returns(uint256[] memory) {
    ...
    // ------------------------------------------------------------------------
    function getAllContentCount() external view returns(uint256) {
    ...
    // ------------------------------------------------------------------------
    function countContentForArticle(uint256 articleId) external view returns(uint256) {
    ...
    // ------------------------------------------------------------------------
    function countContentForSubArticle(uint256 subArticleId) external view returns(uint256) {
    ...
    // ------------------------------------------------------------------------
    function getPageForSubArticle(uint256 subArticleId, uint256 page) external view returns(string memory,string memory,string memory,string memory,string memory,string memory) {
        //Set up the page
    ...
    // ------------------------------------------------------------------------
    function getPageForArticle(uint256 articleId, uint256 page) external view returns(string memory,string memory,string memory,string memory,string memory,string memory) {
        //Set up the page
        string[] memory contentToReturn = new string[](perPage);
        //Get all content ids for article
