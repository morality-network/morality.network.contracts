...
contract IERC20 {
  ...
  // ------------------------------------------------------------------------
  // Side note: Whoever generates: 0x0000000000000000000000000000000000000000
  // Will be laughing!
  // ------------------------------------------------------------------------
...
contract StorageToken is Moderatable{
    ...
    event ContentAdded(address contentCreator, uint256 indexed articleId, uint256 indexed subArticleId, uint256 indexed contentId, uint256 timestamp, string data);
    ...
    function addContent(address contentCreator, uint256 articleId, uint256 subArticleId, uint256 contentId, uint256 timestamp, string memory data) onlyModerators public {
       emit ContentAdded(contentCreator, articleId, subArticleId, contentId, timestamp, data);
    }
